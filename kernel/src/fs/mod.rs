...
pub static FILE_SYSTEM_MANAGER: Once<SpinNoIrqLock<FileSystemManager>> = Once::new();
...
impl FileSystemManager {
    ...
    pub fn push(&mut self, mount_path: String, file_system: Arc<dyn FileSystem>) {
        self.fs_mgr.insert(mount_path, file_system);
    }
}
...
pub fn init() {
    ...
    FILE_SYSTEM_MANAGER.call_once(|| SpinNoIrqLock::new(file_system_manager));
}
