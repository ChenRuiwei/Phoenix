...
impl<'a> Syscall<'a> {
    ...
    pub async fn syscall(&self, syscall_no: usize, args: [usize; 6]) -> usize {
        ...
        let result = match syscall_no {
            ...
            FCHMOD => self.sys_fchmod(args[0], args[1]),
